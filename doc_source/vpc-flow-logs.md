...
+ **Amazon Athena console** – Create your tables and queries directly in the Athena console\. For more information, [read this page](https://aws.amazon.com/athena/?whats-new-cards.sort-by=item.additionalFields.postDateTime&whats-new-cards.sort-order=desc)\.
