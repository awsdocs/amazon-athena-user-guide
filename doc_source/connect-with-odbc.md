...
| --- | --- | 
| ODBC 1\.1\.15 for Windows 32\-bit | [Windows 32 bit ODBC Driver 1\.1\.15](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.15.1000/Windows/SimbaAthena_1.1.15.1000_32-bit.msi) | 
| ODBC 1\.1\.15 for Windows 64\-bit | [Windows 64 bit ODBC Driver 1\.1\.15](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.15.1000/Windows/SimbaAthena_1.1.15.1000_64-bit.msi) | 
...
| Driver Version | Download Link | 
| --- | --- | 
| ODBC 1\.1\.15 for Linux 32\-bit | [Linux 32 bit ODBC Driver 1\.1\.15](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.15.1000/Linux/simbaathena-1.1.15.1000-1.el7.i686.rpm) | 
| ODBC 1\.1\.15 for Linux 64\-bit | [Linux 64 bit ODBC Driver 1\.1\.15](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.15.1000/Linux/simbaathena-1.1.15.1000-1.el7.x86_64.rpm) | 
...
| Driver Version | Download Link | 
| --- | --- | 
| ODBC 1\.1\.15 for OSX | [OSX ODBC Driver 1\.1\.15](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.15.1000/OSX/SimbaAthena_1.1.15.1000.dmg) | 
...
| Driver Version | Download Link | 
| --- | --- | 
| Documentation for ODBC 1\.1\.15 | [ODBC Driver Installation and Configuration Guide version 1\.1\.15](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.15.1000/docs/Simba+Athena+ODBC+Connector+Install+and+Configuration+Guide.pdf) | 
| Release Notes for ODBC 1\.1\.15 | [ODBC Driver Release Notes version 1\.1\.15](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.15.1000/docs/release-notes.txt) | 

## Migration from the Previous Version of the ODBC Driver<a name="migration-from-previous-odbc-driver"></a>

The current ODBC driver version 1\.1\.15 is a drop\-in replacement of the previous versions of the ODBC driver\. It is also backward compatible with the ODBC driver version 1\.0\.3, if you use the following required steps to make sure that the driver runs\. 
