...
| --- | --- | 
| ODBC 1\.1\.3 for Windows 32\-bit | [Windows 32 bit ODBC Driver 1\.1\.3](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.3/Windows/Simba+Athena+1.1+32-bit.msi) | 
| ODBC 1\.1\.3 for Windows 64\-bit | [Windows 64 bit ODBC Driver 1\.1\.3](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.3/Windows/Simba+Athena+1.1+64-bit.msi ) | 
...
| Driver Version | Download Link | 
| --- | --- | 
| ODBC 1\.1\.3 for Linux 32\-bit | [Linux 32 bit ODBC Driver 1\.1\.3](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.3/Linux/simbaathena-1.1.3.1000-1.i686.rpm) | 
| ODBC 1\.1\.3 for Linux 64\-bit | [Linux 64 bit ODBC Driver 1\.1\.3](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.3/Linux/simbaathena-1.1.3.1000-1.x86_64.rpm) | 
...
| Driver Version | Download Link | 
| --- | --- | 
| Documentation for ODBC 1\.1\.3 | [ODBC Driver Installation and Configuration Guide version 1\.1\.3](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.3/Simba+Athena+ODBC+Install+and+Configuration+Guide.pdf) | 
| Release Notes for ODBC 1\.1\.3 | [ODBC Driver Release Notes version 1\.1\.3](https://s3.amazonaws.com/athena-downloads/drivers/ODBC/SimbaAthenaODBC_1.1.3/release-notes.txt ) | 
