...
+ Enhanced partition schema validation in Athena for Parquet, and, in some cases, for ORC, by allowing re\-ordering of columns\. This enables Athena to better deal with changes in schema evolution over time, and with tables added by the AWS Glue Crawler\. For more information, see [Handling Schema Updates](handling-schema-updates-chapter.md)\.
