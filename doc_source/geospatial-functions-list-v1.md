...
Converts text into a geometry data type\. Returns a value in a varbinary data type, which is a binary representation of the geometry data type\. Example:
...
Returns a value in the varbinary data type, which is a binary representation of the [geometry data type](geospatial-input-data-formats-supported-geometry-types.md#geometry-data-types) `line`\. Example:
...
Returns a value in the varbinary data type, which is a binary representation of a `point` geometry data type\.
...
In Athena engine version 1, all operation functions take one of the geometry data types as an input and return a binary representation as a varbinary data type\.
